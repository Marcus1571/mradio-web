...
CATEGORICAL_HALLUCINATION_RULES = (
    ...
    "  8. For a well-known WORK (not just this recording): (a) who "
    "first recorded/premiered it, with year and record label if "
    "certain, no venue; and/or (b) up to 2-3 OTHER well-known artists "
    "who notably recorded/performed this same work, each as name + "
    "rough era/decade only — no chart performance, no awards, no "
    "anecdote about why any of these recordings matter, no claim about "
    "which is \"best\" or \"definitive\". List names only if you are "
    "certain each one actually recorded this specific work, not artists "
    "who plausibly might have.\n"
    ...
    "SLOT 5 (OPTIONAL, per category 8 above, ONLY for a well-known "
    "WORK — skip for an obscure one): who first recorded/premiered the "
    "work (year + label if certain), and/or up to 2-3 other well-known "
    "artists who notably recorded this same work (name + rough era "
    "only, no anecdote, no ranking). 1 sentence, or skip entirely.\n"
