...
## Language support (added 2026-09-05, 0.2.0 + 0.2.1 + 0.3.1; Portuguese + pattern cleanup 2026-09-06, 0.3.5; French 2026-09-06, 0.3.10; Russian 2026-09-06, 0.5.8; German 2026-09-06, 0.5.9) — fully done
...
French in 0.3.10 + Russian in 0.5.8 + German in 0.5.9) —
`frontend/src/i18n/` (hand-rolled `en.ts`/`es.ts`/`it.ts`/`pt.ts`/
`fr.ts`/`ru.ts`/`de.ts`/`index.ts`, no library, `Dict` type widening so
non-English files only have to match English's key shape, not its
exact text). Adding a language is now a proven 6-spot pattern
(confirmed for Italian in 0.3.1, Portuguese in 0.3.5, French in 0.3.10,
Russian in 0.5.8, German in 0.5.9 — see
...
German added 0.5.9) — `Enricher.language` mirrors `self.provider`'s
...
(English stays fully implicit — zero prompt-text cost — Spanish/Italian/
Portuguese/French/Russian/German each add one line asking for the
